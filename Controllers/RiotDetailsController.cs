...
namespace WebApplication1.Controllers
{
    ...
    [ApiController]
    public class RiotDetailsController : ControllerBase
    {
        [HttpPost("{id}")]
        public Tuple<bool, string> Post(TheftEntity entity)
        {
            ...
            using (sqlConnection = new MySqlConnection(connectionString))
            {
                ...
                try
                {
                    ...
                    cmd.CommandText = "InsertRiotDetails";
                    ...
                    mail.SendMailForIncident(entity, "Riots");
        ...
        public string Get(string FDate, string TDate)
        {
            ...
            try
            {
                ...
                ds = manageSqlConnection.GetDataSetValues("GetRiotDetails", sqlParameters);
